...
```bash
curl -L https://github.com/<owner>/kanboard/releases/latest/download/kanboard-linux-x64 -o kanboard
chmod +x kanboard
...
```bash
curl -L https://github.com/<owner>/kanboard/releases/latest/download/kanboard-macos-arm64 -o kanboard
chmod +x kanboard
sudo mv kanboard /usr/local/bin/kanboard
```
...
```bash
curl -L https://github.com/<owner>/kanboard/releases/latest/download/kanboard-macos-x64 -o kanboard
chmod +x kanboard
sudo mv kanboard /usr/local/bin/kanboard
```
